...
export default function Hero() {
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center bg-white bg-opacity-75 rounded-lg p-6 lg:w-120 lg:h-60 lg:p-8">
        <div className="flex flex-col text-center gap-6 items-center">
          <h1 className="text-xl font-medium lg:font-semibold lg:text-3xl">
